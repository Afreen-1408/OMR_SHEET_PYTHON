...
small_column_height = 10
small_column_x = left_column_x + BUBBLE_RADIUS - small_column_width // 2

for _ in range(4):
    small_column_y = left_column_y + COLUMN_HEIGHT + BUBBLE_GAP - small_column_height
    canvas.rect(small_column_x, small_column_y, small_column_width, small_column_height)
    small_column_x += (2 * BUBBLE_RADIUS) + BUBBLE_GAP

# Add the "Roll No:" label on the left side
roll_label_x = left_column_x - (-10)
roll_label_y = left_column_y + COLUMN_HEIGHT 
